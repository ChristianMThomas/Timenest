    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/timelogs/start-shift").hasRole("EMPLOYEE")
                        .requestMatchers("/timelogs/end-shift").hasRole("EMPLOYEE")
                        .requestMatchers("/timelogs/active-shift").hasRole("EMPLOYEE")
                        .requestMatchers("/shift-monitoring/**").hasAnyRole("EMPLOYEE", "EXECUTIVE")
